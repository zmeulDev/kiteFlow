            ...
            @if($step === 'search')
                ...
                @elseif($mode === 'qr')
                    <div class="qr-scanner" id="qr-scanner">
                        <span>📷 Camera scanner will appear here</span>
                    </div>
                ...
                <div class="checkbox-group">
                    <label class="checkbox-label">
                        ...
                        <span class="checkbox-text">
                            ...
                            <small style="color: #666;">{{ Str::limit($tenant->nda_text, 100) }}</small>
                        </span>
                    </label>
                </div>
                @endif
                ...
                <div class="checkbox-group">
                    <label class="checkbox-label">
                        ...
                        <span class="checkbox-text">
                            ...
                            <small style="color: #666;">{{ Str::limit($tenant->terms_text, 100) }}</small>
                        </span>
                    </label>
                </div>
                @endif
