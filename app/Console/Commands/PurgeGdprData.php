...
class PurgeGdprData extends Command
{
    ...
    public function handle(): int
    {
        ...
        foreach ($tenants as $tenant) {
            ...
            $this->info("Processing tenant: {$tenant->name} (retention: {$retentionMonths} months)");
            ...
            // Optionally delete visitors with no more visits
            // (Uncomment if you want to auto-delete visitors)
            /*
            ...
            */
            ...
            $this->info("  Purged: {$purgedVisits} visits, {$purgedCheckIns} check-ins");
        }

        $this->info("GDPR purge completed: {$purgedVisits} visits, {$purgedCheckIns} check-ins purged.");

        Log::info("GDPR purge completed: {$purgedVisits} visits, {$purgedCheckIns} check-ins");
